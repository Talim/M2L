...
<body>
  ...
  <main>
    <center>
      ...
      <h5 class="indigo-text">Veuillez indiquer vos identifiants de connexion</h5>
      <div class="section"></div>
      ...
      <div class="container">
        <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE; width:500px;">
          ...
          <form class="col s12" action="controleur/c_accueil.php?action=loadAtelier" method="post">
            <div class='row'>
              <div class='col s12'>
              </div>
            </div>
